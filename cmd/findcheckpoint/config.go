...
var (
	...
	defaultDataDir  = filepath.Join(czzdHomeDir, "data")
...
type config struct {
	...
	UseGoOutput    bool   `short:"g" long:"gooutput" description:"Display the candidates using Go syntax that is ready to insert into the czzchain checkpoint list"`
}
