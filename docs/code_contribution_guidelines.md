...
reason, the bourbaki-czz suite has a formalized and rigorous development process which
...
- [Effective Go](http://golang.org/doc/effective_go.html) - The entire bourbaki-czz
...
One of the major design goals of all core classzz packages is to aim for complete
...
commits](https://github.com/bourbaki-czz/classzz/commits/master) for examples of
commit messages.
...
contributions.  This is how to get your changes into classzz.
...
Rejoice as you will now be listed as a [contributor](https://github.com/bourbaki-czz/classzz/graphs/contributors)!
...
[ISC license](https://github.com/bourbaki-czz/classzz/blob/master/LICENSE).  This is
the same license as all of the code in the bourbaki-czz suite.
