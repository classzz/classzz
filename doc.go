...
/*
classzz is a full-node bitcoin cash implementation written in Go.

The default options are sane for most users.  This means classzz will work 'out of
...
parsed when classzz starts up.  By default, the configuration file is located at
~/.classzz/classzz.conf on POSIX-style operating systems and %LOCALAPPDATA%\classzz\classzz.conf
...
Application Options:
  ...
  -d, --debuglevel=         Logging level for all subsystems {trace, debug,
      ...
      --minrelaytxfee=      The minimum transaction fee in CZZ/kB to be
