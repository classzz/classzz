...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/bourbaki-czz/classzz/mining/cpuminer)
...
```bash
$ go get -u github.com/bourbaki-czz/classzz/mining/cpuminer
```
