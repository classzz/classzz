...
var helpDescsEnUS = map[string]string{
	...
	"debuglevel--synopsis": "Dynamically changes the debug logging level.\n" +
		...
		"The valid subsystems are AMGR, ADXR, BCDB, BMGR, CLASSZZ, CHAN, DISC, PEER, RPCS, SCRP, SRVR, and TXMP.\n" +
	...
	"createrawentangletransaction-amounts--value": "n.nnn",
	"createrawentangletransaction-amounts--desc":  "The destination address as the key and the amount in BTC as the value",
	...
	"sendrawtransaction-allowhighfees": "Whether or not to allow insanely high fees (classzz does not yet implement this parameter, so it has no effect)",
	...
	// StopCmd help.
	"stop--synopsis": "Shutdown classzz.",
	"stop--result0":  "The string 'classzz stopping.'",
	...
	// NotifySpentCmd help.
	"notifyspent--synopsis": "Send a redeemingtx notification when a transaction spending an outpoint appears in mempool (if relayed to this classzz instance) and when such a transaction first appears in a newly-attached block.",
...
var rpcResultTypes = map[string][]interface{}{
	...
	"mortgage":              {(*string)(nil)},
	"addmortgage":           {(*string)(nil)},
	"updatecoinbaseall":     {(*string)(nil)},
	"convert":               {(*string)(nil)},
	"casting":               {(*string)(nil)},
	...
	"getconvertitems":       {(*[]*btcjson.ConvertItemsResult)(nil)},
