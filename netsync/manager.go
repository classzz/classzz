...
import (
	...
	peerpkg "github.com/classzz/classzz/peer"
...
func (sm *SyncManager) startSync() {
	...
	if bestPeer != nil {
		...
		log.Infof("Syncing to block height %d / bestHeight %d from peer %v ",
			bestPeer.LastBlock(), best.Height, bestPeer.Addr())
...
// processed.
func (sm *SyncManager) QueueTx(tx *czzutil.Tx, peer *peerpkg.Peer, done chan struct{}) {
...
// processed.
func (sm *SyncManager) QueueBlock(block *czzutil.Block, peer *peerpkg.Peer, done chan struct{}) {
...
// chain.
func (sm *SyncManager) ProcessBlock(block *czzutil.Block, flags blockchain.BehaviorFlags) (bool, error) {
